...
data.grid(column=8, row=0, pady=10)
...
valor.grid(column=8, row=7)

# radio button
navegador = tk.StringVar(value="Firefox")
radio1 = tk.Radiobutton(janela, text="Firefox", variable=navegador, value="Firefox")
radio2 = tk.Radiobutton(janela, text="Chrome", variable=navegador, value="Chrome")

radio1.grid(column=5, row=15)
radio2.grid(column=8, row=15)
...
botao.grid(column=8, row=17, pady=10)
